...
```bash
python -m rsfseg.stage_2_display --build=$data --organs aorta
```

Or you can show multiple organs by listing them with spaces in between:

```bash
python -m rsfseg.stage_2_display --build=$data --organs aorta liver pancreas
```
...
```bash
python -m rsfseg.stage_3_measure --build=$data --organs aorta
```

To do this for multiple organs, separate them with spaces:

```bash
python -m rsfseg.stage_3_measure --build=$data --organs aorta liver
```
...
```bash
python -m rsfseg.stage_4_edit --build=$data --organ aorta
```

By default this is editing in the coronal plane. To edit in the axial plane instead, provide the *plane* argument:

```bash
python -m rsfseg.stage_4_edit --build=$data --organ aorta --plane axial
```

Or sagittal:

```bash
python -m rsfseg.stage_4_edit --build=$data --organ aorta --plane sagittal
```
...
```bash
python -m rsfseg.stage_5_display --build=$data --organs aorta
```

Or multiple organs:

```bash
python -m rsfseg.stage_5_display --build=$data --organs aorta liver pancreas
```
...
```bash
python -m rsfseg.stage_6_measure --build=$data --organs aorta
```

Measure multiple organs:

```bash
python -m rsfseg.stage_6_measure --build=$data --organs aorta liver
```
